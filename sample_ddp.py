...
def generate(model, diffusion, vae,
             sample_folder_dir,
             rank, device, cfg_scale=1.0, 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--id_min", type=int, default=0)
    parser.add_argument("--id_max", type=int, default=100000)
    parser.add_argument("--id_step", type=int, default=50000)
